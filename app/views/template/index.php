...
<head>
  ...
  <link rel="stylesheet" href="<?= site_url('https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback'); ?>">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?= site_url('assets/plugins/fontawesome-free/css/all.min.css'); ?>">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?= site_url('https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css'); ?>">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a>Mgel's Sales & Inventory</a>.</strong>
    All rights reserved.
