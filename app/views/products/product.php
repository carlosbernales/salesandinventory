      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h1>Products</h1>
            <div>
            <a href="add_product" class="btn btn-primary mt-2 mb-2">Add New Product</a>
            </div>
            <div class="card">
              <div class="card-body">
                <table class="table table-striped">
                  ...
                  <?php foreach ($data as $datum): ?>
                      <tr>
                          ...
                          <td><a href="<?=site_url('index.php/home/update/'.$datum['id'].'');?>" class="btn btn-info">Edit</td>
                          <td><a href="<?=site_url('index.php/home/delete_product/'.$datum['id'].'');?>" class="btn btn-danger" onclick="return confirm('Do you want to delete?')">Delete</td>
                      </tr>
                  <?php endforeach; ?>
                </table>    
              </div>
